...
export const REPORT_SECTIONS: ReportSection[] = [
  {
    ...
    stats: [
      ...
      },
      {
        value: "1 of 3",
        label:
          "2027 child-poverty targets Budget 2026 will meet, per Treasury; ~48,000–50,000 more children in hardship than three years ago",
        calculation:
    ...
    pullquote:
      "169,300 children in material hardship is a 10-year high — but the story is who, where, and how deeply: Pacific 31.0%, Māori 25.1%, and roughly 62,000 children poor purely because of housing costs.",
    sources: [
      ...
      "Save the Children / CPAG NZ (Feb 2026) — ~6 in 10 poor children have a working parent",
  ...
  },
  {
    ...
    subhead:
      "One in seven tamariki are in material hardship — a ten-year high — and a child's address and ethnicity, not the national average, decide who goes without.",
    paragraphs: [
      "In the year ended June 2025, 169,300 New Zealand children — 14.3% of all tamariki — were living in material hardship, the highest rate in a decade. Material hardship is poverty measured in lived terms: it counts households going without six or more basics from a list of seventeen, things like heating the home, eating fresh fruit and vegetables, seeing a doctor, or replacing worn-out shoes. Within that group, 71,000 children (6.0%) are in severe hardship, lacking nine or more essentials — up from 4.0% in 2022. A third measure, the combined count of children who are both on a low income and in hardship, sits at 101,600 (8.6%). This is the non-cyclical hard core: the children whose poverty does not lift when the economy turns.",
      "These three statutory measures matter because the Child Poverty Reduction Act binds the Government to reduce them. All three are now off track and moving the wrong way. The legislated 2028 target for material hardship is 6.0% — less than half today's rate — while the interim 2024 targets (the before-housing-costs line at 10% and the after-housing-costs line at 15%) were all missed. Treasury concedes that on current settings Budget 2026 will meet only one of its three modelled 2027 targets, and roughly 48,000 to 50,000 more children are in hardship than three years ago. The targets are being missed by design, not by accident: officials advised that around $3 billion a year would be needed to hit them, and that advice was not taken up.",
      "Behind the rise, the trajectory is unambiguous. Pulled live from the child-poverty-nz skill, the official series runs from 13.3% (147,600 children) in 2018, down to a low of 10.6% (121,800) in 2022, then back up to 14.3% (169,300) in 2025 — a 3.7 percentage-point climb off the 2022 trough that is an additional 47,500 children in hardship in just three years. The latest single-year move was +0.8 points, about 10,500 more children, against a total child population of 1,182,800. A decade-high hardship rate alongside stalled income measures shows the country moving away from its own legislated goals.",
    ...
    stats: [
      {
        value: "169,300",
        label:
          "Children in material hardship (14.3%) — a 10-year high; +47,500 since the 2022 low of 10.6% (121,800)",
        calculation:
    ...
    sources: [
      ...
      "CPAG, 'Latest official child poverty measures 2024/25', 26 February 2026 (2028 material-hardship target 6.0%; 2024 targets BHC50 10% / AHC50 15% all missed; Child Poverty Reduction Act)",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Work no longer reliably buys the way out. A record 409,575 working-age New Zealanders draw a main benefit — 12.7 per cent of the working-age population — including 215,214 on Jobseeker Support and 108,498 on the Supported Living Payment, the latter tying poverty tightly to disability. And the people in work are not safe either: about six in ten children in poverty have a parent who works. That single finding undercuts the premise beneath the whole work-incentive architecture. When benefits and minimum-wage work both fall short of a basic income floor — by $100 to $300 a week depending on family type — the question stops being whether people are trying and becomes whether the floor itself is high enough to stand on.",
      ...
      "What would move it is not mysterious. The Welfare Expert Advisory Group recommended in 2019 that core benefits rise by between 12 and 47 per cent depending on family type; five years on, not one of its 42 key recommendations has been fully implemented. The natural experiment already ran: when benefits were lifted and re-indexed to wages from 2018 to 2022, after-housing-costs child poverty fell, with an estimated 19,000 to 33,000 children lifted clear. Those gains have since unwound. The cleanest single lever is to restore wage indexation (or index to the higher of wages or CPI) and lift rates toward the WEAG benchmark — and to extend the In-Work Tax Credit to beneficiary children, who are currently excluded by rule: CPAG estimates a one-to-three-child benefit family missed out on $18,850 over five years. Budget 2026 raised the IWTC by $50 a week but kept that exclusion intact, which is why advocates called it a washout.",
    ...
    pullquote:
      "About six in ten children in poverty have a parent who works — when the income floor itself is too low to stand on, effort is not the missing ingredient.",
    crossLink: {
      href: "/simulator",
      label:
    ...
    sources: [
      ...
      "MSD Supplementary Analysis Report, indexing main benefits to inflation: https://www.msd.govt.nz/documents/about-msd-and-our-work/publications-resources/regulatory-impact-statements/sar-indexing-main-benefits-to-inflation.docx",
      "Treasury AN22-04 (2018–2022 package lifted an estimated 19,000–33,000 children out of AHC poverty): https://www.treasury.govt.nz/sites/default/files/2022-09/an22-04.pdf",
  ...
  },
  {
    ...
    sources: [
      ...
      "public-housing-nz skill — HUD Accommodation Supplement recipients & weekly spend (data.govt.nz), as at 1 Dec 2024: 385,025 recipients, $42,451,478.50/week (summed across 12 MSD regions). NOTE: this supersedes the report's prior 769,954 / ~$84.9m, which could not be reproduced from the HUD dataset.",
  ...
  },
  {
    ...
    sources: [
      ...
      "NZ Food Network Hunger Monitor 2025 (1 in 3 food-insecure; foodbanks 500,000+/month, +165%); Save the Children / CPAG NZ Feb 2026 (~6 in 10 poor children have a working parent).",
    ],
  },
  {
    id: "whatworks",
    ...
    stats: [
      {
        ...
        calculation:
          "Treasury AN22-04 estimate for the benefit-increase changes on the AHC measure, 2022/23",
        source:
          "Treasury AN22-04 (treasury.govt.nz/sites/default/files/2022-09/an22-04.pdf)",
      },
      {
        value: "~7,000",
        label:
    ...
    sources: [
      ...
      "Treasury AN22-04 (treasury.govt.nz/sites/default/files/2022-09/an22-04.pdf) — 19,000–33,000 children lifted, 2022/23",
  ...
  },
  {
    ...
    recommendations: [
      {
        ...
        leverage:
          "Highest. Lifting rates ~$36/wk (single Jobseeker) to $100–300/wk (families) reverses the modelled drift; the 2018–2022 wage-indexed package helped lift an estimated 19,000–33,000 children out of AHC poverty. Modellable directly in /simulator.",
      },
      {
        action:
        ...
        rationale:
          "Budget 2026's $50/wk IWTC rise still excludes beneficiary children — the very cohort at greatest risk. With about 6 in 10 poor children already having a working parent, the work-gate no longer maps onto who is poor. CPAG estimates a 1–3 child benefit family missed out on $18,850 over five years. This removes the single largest policy-design driver of severe child hardship.",
        leverage:
      ...
      },
      {
        ...
        rationale:
          "Treasury concedes Budget 2026 will meet only 1 of 3 modelled 2027 targets, with ~48,000–50,000 more children in hardship than three years ago. Officials advised roughly $3b/yr was needed; lowering the interim targets manages the optics, not the poverty. Accountability is a lever in its own right — without it, the income and housing levers above are easy to defer.",
        leverage:
          "Systemic. Keeps the other seven actions honest and measurable against the legislated 2028 material-hardship target of 6.0%.",
      },
    ],
    stats: [
      {
    ...
    sources: [
      ...
      "MSD Supplementary Analysis Report, indexing main benefits to inflation: https://www.msd.govt.nz/documents/about-msd-and-our-work/publications-resources/regulatory-impact-statements/sar-indexing-main-benefits-to-inflation.docx",
      "Treasury AN22-04 (2018–2022 package, 19,000–33,000 children): https://www.treasury.govt.nz/sites/default/files/2022-09/an22-04.pdf",
      ...
      "RNZ Budget 2026 coverage (28 May 2026) — 1 of 3 targets met, ~48,000–50,000 more children, ~$3b/yr advised: https://www.rnz.co.nz/news/political/596701/50-000-more-children-suffering-from-material-hardship-than-three-years-ago",
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        value: "~116,000",
        label:
          "Cold-homes count to use (5.8% of ~2m, 2024) — reconciling the surfaced ~110,000 vs ~116,000 discrepancy",
        calculation:
          "5.8% of ~2 million households = ~116,000; the 110,000 figure is inconsistent with 5.8%",
        source: "research critiquesAndConfidence consistencyIssues",
      },
      {
        value: "385,025",
        label:
          "Accommodation Supplement recipients (~$42.5m/wk, 1 Dec 2024) — corrected from the prior 769,954 / ~$84.9m, which could not be reproduced from HUD",
        calculation:
    ...
    sources: [
      ...
      "Treasury AN22-04 (2018–2022 package, 19,000–33,000 children estimate)",
